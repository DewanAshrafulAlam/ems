<template>
  <div class="max-w-md mx-auto bg-white p-6 rounded shadow">
    ...
    <form @submit.prevent="submitForm" class="space-y-4">
      ...
      <input v-model="form.email" type="text" placeholder="Email" class="block w-full border rounded px-3 py-2" />
      <input v-model="form.mobile" type="text" placeholder="Mobile" class="block w-full border rounded px-3 py-2" />
